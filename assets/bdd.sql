...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 01 déc. 2025 à 12:33
...
(125, 'items', 1, 1, 'test_resume_fr', 'test_resume_fr\nL’informatique est la science qui étudie le traitement automatique de l’information à l’aide de machines, en particulier des ordinateurs. Elle repose sur la capacité à représenter les données sous une forme que les machines peuvent comprendre, à les manipuler selon des instructions précises et à produire des résultats utiles à l’être humain. Ses origines remontent bien avant l’apparition des ordinateurs modernes, avec les premières tentatives de calcul mécanique au XVIIᵉ siècle, comme la machine de Pascal ou celle de Leibniz. Au XXᵉ siècle, les progrès en électronique et en mathématiques ont permis la naissance de l’informatique telle qu’on la connaît, notamment avec les travaux d’Alan Turing, qui a défini les bases théoriques de la machine programmable.\nL\'informatique traite l\'information avec des machines depuis le XVIIe siècle jusqu\'aux avancées du XXe siècle par Turing.');
...
(125, 1, NULL, NULL, NULL, 'test_resume_fr', 1, '2025-12-01 12:32:20', '2025-12-01 12:32:20', 'Omeka\\Entity\\Item');
...
(245, 125, 1, NULL, NULL, 'literal', NULL, 'test_resume_fr', NULL, 1),
(246, 125, 4, NULL, NULL, 'literal', NULL, 'L’informatique est la science qui étudie le traitement automatique de l’information à l’aide de machines, en particulier des ordinateurs. Elle repose sur la capacité à représenter les données sous une forme que les machines peuvent comprendre, à les manipuler selon des instructions précises et à produire des résultats utiles à l’être humain. Ses origines remontent bien avant l’apparition des ordinateurs modernes, avec les premières tentatives de calcul mécanique au XVIIᵉ siècle, comme la machine de Pascal ou celle de Leibniz. Au XXᵉ siècle, les progrès en électronique et en mathématiques ont permis la naissance de l’informatique telle qu’on la connaît, notamment avec les travaux d’Alan Turing, qui a défini les bases théoriques de la machine programmable.', NULL, 1),
(247, 125, 19, NULL, NULL, 'literal', NULL, 'L\'informatique traite l\'information avec des machines depuis le XVIIe siècle jusqu\'aux avancées du XXe siècle par Turing.', NULL, 1);
